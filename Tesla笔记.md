...
Predicting corridors(road profile) in BEV. 红色为十字路口，小箭头为traffic flow的方向。
...
![2020-11-01 01-34-49 的屏幕截图](2020-11-01 01-34-49 的屏幕截图.png)

![2020-11-01 01-39-06 的屏幕截图](2020-11-01 01-39-06 的屏幕截图.png)

![2020-11-01 01-41-57 的屏幕截图](2020-11-01 01-41-57 的屏幕截图.png)

这里可能暗示了网络使用前视3目获得深度。

![2020-11-01 01-44-19 的屏幕截图](2020-11-01 01-44-19 的屏幕截图.png)

网络规模如此之大，以至于单次forward pass都于无法在一块GPU、甚至是一个node上完成。因此tesla的网络训练强依赖于分布式系统。

![2020-11-01 01-47-45 的屏幕截图](2020-11-01 01-47-45 的屏幕截图.png)

![2020-11-01 01-56-55 的屏幕截图](2020-11-01 01-56-55 的屏幕截图.png)
...
![2020-11-01 02-05-10 的屏幕截图](2020-11-01 02-05-10 的屏幕截图.png)

![2020-11-01 02-06-12 的屏幕截图](2020-11-01 02-06-12 的屏幕截图.png)

![2020-11-01 02-07-41 的屏幕截图](2020-11-01 02-07-41 的屏幕截图.png)

![2020-11-01 02-09-56 的屏幕截图](2020-11-01 02-09-56 的屏幕截图.png)

![2020-11-01 02-11-39 的屏幕截图](2020-11-01 02-11-39 的屏幕截图.png)

![2020-11-01 02-16-05 的屏幕截图](2020-11-01 02-16-05 的屏幕截图.png)

![2020-11-01 02-18-41 的屏幕截图](2020-11-01 02-18-41 的屏幕截图.png)

![2020-11-01 02-20-27 的屏幕截图](2020-11-01 02-20-27 的屏幕截图.png)

![2020-11-01 02-21-54 的屏幕截图](2020-11-01 02-21-54 的屏幕截图.png)

# Path prediction (Andrej Karpathy)

https://www.youtube.com/watch?v=v5l-jPsAK7k

2019年11月10日

Path prediction甚至能在十字路口工作。网络真值来源：依靠GPS，steering，IMU，IMAGES推算本车轨迹。此被称为：imitation learning。

![2020-11-01 02-31-05 的屏幕截图](2020-11-01 02-31-05 的屏幕截图.png)

其中提到了网络对path的预测为3d预测。

![2020-11-01 02-34-45 的屏幕截图](2020-11-01 02-34-45 的屏幕截图.png)

# Predicting cut-ins (Andrej Karpathy)

https://www.youtube.com/watch?v=A44hbogdKwI

2019年11月10日

CUT-INS 数据由MOT序列自动化标注；

![2020-11-01 02-41-41 的屏幕截图](2020-11-01 02-41-41 的屏幕截图.png)

# Object detection (Andrej Karpathy)

https://www.youtube.com/watch?v=33K3id2xNAE

2019年11月10日

这个视频主要讲了Tesla如何利用他的fleet来提升object detection的质量。

其中在这个场景，自行车被放置在汽车后。虽然检测出两个框也make sense，然而对于planer和controler而言，更希望检出一个框，即此时自行车是属于汽车的一部分。为了获得这种场景的数据，Tesla会要求他的fleet只要遇到这种场景，就回传数据，然后Tesla就针对这种场景进行训练。

![2020-11-02 01-29-28 的屏幕截图](2020-11-02 01-29-28 的屏幕截图.png)

![2020-11-02 01-33-44 的屏幕截图](2020-11-02 01-33-44 的屏幕截图.png)

![2020-11-02 01-34-37 的屏幕截图](2020-11-02 01-34-37 的屏幕截图.png)

除了在汽车上的自行车，Tesla还会要求fleet收集其他corner case场景：

![2020-11-02 01-35-45 的屏幕截图](2020-11-02 01-35-45 的屏幕截图.png)

![2020-11-02 01-36-56 的屏幕截图](2020-11-02 01-36-56 的屏幕截图.png)

![2020-11-02 01-37-33 的屏幕截图](2020-11-02 01-37-33 的屏幕截图.png)

![2020-11-02 01-38-13 的屏幕截图](2020-11-02 01-38-13 的屏幕截图.png)
